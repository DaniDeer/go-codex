...
- **Sweep the WHOLE repo, not just the package being changed.** A symbol removed from
  ...
  exception. See `docs/design/middleware-workflow-simplification.md`'s "Lessons Learned" for a
...
- **A `MissingSecurityMiddlewareError`/`CheckCoverage`-style regression can hide behind a clean
  ...
  this," the same way `docs/design/middleware-workflow-simplification.md`'s Lessons Learned

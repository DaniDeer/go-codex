...
| `api/zeromq`                   | AsyncAPI 3.0 spec builder for ZMQ REQ/REP contracts; bridges `rest.Route[Req,Resp]` declarations to a ZMQ-specific AsyncAPI document with request-reply operations; `Register[Req,Resp](b *Builder, route rest.Route[Req,Resp], meta SocketMeta) (*rest.RouteHandle[Req,Resp], error)` — free generic function; adds two channels (request + reply) and one send operation with `reply:` block to the builder, returns the same `*rest.RouteHandle` usable directly with `adapters/zeromq.Serve`/`Call`; `Builder.AsyncAPISpec() (asyncapi.Document, error)` — emits AsyncAPI 3.0 with `protocol: zmq`; `SocketMeta{OperationID, Summary, Description, Tags, ReqSchemaName, RespSchemaName}` — operation IDs default to path-derived camelCase when OperationID is empty; `Info = asyncapi.Info` alias; `Server = asyncapi.Server` alias; `Builder.AddServer(name, Server)` — chains; **import rule**: `api/zeromq` does NOT import `adapters/zeromq` (API layer must not depend on adapter layer)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `api/rest`, `render/asyncapi/v3`, `schema`                                 |

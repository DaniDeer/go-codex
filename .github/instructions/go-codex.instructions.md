...
- `Descriptor route.Route` — live descriptor; updated by `WithRequestFormats` / `WithResponseFormats`; use for framework routing and spec generation

...
`docs/roadmap/pubsub-workflow-simplification.md`'s Decision 5 and
...
**Decision 6 (`docs/roadmap/pubsub-workflow-simplification.md`'s "Decision 6" section) later
...
**Decision 7 (`docs/roadmap/pubsub-workflow-simplification.md`'s "Decision 7" section) later
...
// versions, per Decision 7 of docs/roadmap/pubsub-workflow-simplification.md:

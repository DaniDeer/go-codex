...
// one module's container image in a deployment manifest file — the
// request type+codec and the MCP tool declaration. Pure data — no I/O,
// no ports.File. The concrete implementation (which actually parses the

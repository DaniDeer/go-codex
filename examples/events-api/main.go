...
func main() {
	...
	demoErrorChannelPublishSide(ctx)
	demoErrorChannelSubscribeSideAndConsumer(ctx)
	demoErrorChannelDirectMode(ctx)
	demoErrorChannelActions(ctx)
	demoErrorChannelDeadLetterFallback(ctx)

...
func (e RequestBuildError) Error() string {
	return fmt.Sprintf("openai: build request: %s", e.Err)
}
...
func (e RequestBuildError) LogValue() slog.Value {
	return slog.GroupValue(slog.Any("cause", e.Err))
}
...
func (e RequestError) Error() string {
	return fmt.Sprintf("openai: model %q: %s", e.Model, e.Err)
}
...
func (e UnexpectedStatusError) Error() string {
	return fmt.Sprintf("openai: model %q: unexpected status %d", e.Model, e.StatusCode)
}
...
func (e ResponseBodyError) Error() string {
	return fmt.Sprintf("openai: read response body: %s", e.Err)
}
...
func (e NoChoicesError) Error() string {
	return fmt.Sprintf("openai: model %q: response contained zero completion choices", e.Model)
}

// LogValue implements [slog.LogValuer] for structured logging.
func (e NoChoicesError) LogValue() slog.Value {
	return slog.GroupValue(slog.String("model", e.Model))
}
...
func (e RetriesExhaustedError) Error() string {
	return fmt.Sprintf("openai: model %q: exhausted %d attempt(s) without a valid completion: %v",
		e.Model, e.Attempts, e.LastErr)
}
